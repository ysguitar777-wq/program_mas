...
- **用語集** — よく使われるプログラミング用語 64 語をカテゴリ別に収録。検索・絞り込みができます。
- **おまけ: このサイトの作り** — このサイト自体の HTML / CSS / JS の仕組みを実コード付きで解説する 8 章。SPA ルーティング、localStorage、シンタックスハイライトの自作方法など。改造課題付き。
- **効率よく学習できる工夫**
